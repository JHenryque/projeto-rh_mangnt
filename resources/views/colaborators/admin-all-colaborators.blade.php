                        ...
                        <td>
                            <div class="d-flex gap-3 justify-content-end">
                               ...
                               @if(empty($colaborator->deleted_at))
                                    <a href="{{ route('colaborators.show-details', ['id' => $colaborator->id ]) }}" class="btn btn-sm btn-outline-dark ms-3"><i class="fa-regular fa-eye me-2"></i>Details</a>
                                ...
                                @else
                                    <a href="{{ route('colaborators.restore', ['id'=> $colaborator->id]) }}" class="btn btn-sm btn-outline-danger ms-3"><i class="fa-solid fa-trash-arrow-up me-2"></i>Restore</a>
                                @endif
